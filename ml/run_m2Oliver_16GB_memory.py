from m2Oliver_16GB_memory import M2OliverModel16GBMemory
...
def main():
    ...
    protein_mol_interaction_model = M2OliverModel16GBMemory(protein_input_shape, molecule_input_shape, num_classes)
